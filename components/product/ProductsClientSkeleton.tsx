export default function ProductsClientSkeleton() {
  return (
    <section>
      <div className="space-y-8 animate-pulse">
        {/* Filter Bar */}
        <div className="bg-surface rounded-2xl p-5 shadow-soft border border-border-muted animate-pulse">
          ...
          <div className="flex items-center justify-between pt-10">
            {/* Apply Button */}
            <div className="h-9 w-32 bg-border-muted rounded-xl" />

            {/* Clear Filters (optional placeholder space) */}
